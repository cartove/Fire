...
# Generated by qmake (3.0) (Qt 5.0.1) on: Fri Jun 7 22:15:23 2013
# Project:  shading.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lGLU -lGLEW -lglut -lQt5Gui -L/usr/lib/x86_64-linux-gnu -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/shading1.0.0/ && $(COPY_FILE) --parents cube.h light_source.h material.h sphere.h drawable.h include/Angel.h include/CheckError.h include/mat.h include/vec.h mesh.h .tmp/shading1.0.0/ && $(COPY_FILE) --parents cube.cpp InitShader.cpp light_source.cpp sphere.cpp material.cpp drawable.cpp lab7.cpp .tmp/shading1.0.0/ && (cd `dirname .tmp/shading1.0.0` && $(TAR) shading1.0.0.tar shading1.0.0 && $(COMPRESS) shading1.0.0.tar) && $(MOVE) `dirname .tmp/shading1.0.0`/shading1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/shading1.0.0
...
lab7.o: lab7.cpp include/Angel.h \
		include/vec.h \
		include/mat.h \
		include/CheckError.h \
		drawable.h \
		...
		sphere.h \
		mesh.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lab7.o lab7.cpp
