#############################################################################
# Makefile for building: shading
# Generated by qmake (3.0) (Qt 5.0.1) on: Sat Jun 8 19:12:12 2013
# Project:  shading.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile shading.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lGLU -lGLEW -lglut -lm -lsfml-system -lsfml-audio -lQt5Gui -L/usr/lib/x86_64-linux-gnu -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: shading.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile shading.pro
...
dist: 
	@test -d .tmp/shading1.0.0 || $(MKDIR) .tmp/shading1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/shading1.0.0/ && $(COPY_FILE) --parents cube.h light_source.h material.h sphere.h drawable.h include/Angel.h include/CheckError.h include/mat.h include/vec.h mesh.h particle.h objloader.h .tmp/shading1.0.0/ && $(COPY_FILE) --parents cube.cpp InitShader.cpp light_source.cpp sphere.cpp material.cpp drawable.cpp main.cpp particle.cpp objloader.cpp .tmp/shading1.0.0/ && (cd `dirname .tmp/shading1.0.0` && $(TAR) shading1.0.0.tar shading1.0.0 && $(COMPRESS) shading1.0.0.tar) && $(MOVE) `dirname .tmp/shading1.0.0`/shading1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/shading1.0.0
...
light_source.o: light_source.cpp light_source.h \
		...
		include/mat.h \
		include/CheckError.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o light_source.o light_source.cpp
